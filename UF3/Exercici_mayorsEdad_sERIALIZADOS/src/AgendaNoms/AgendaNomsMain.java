...
//                    break;
                    ...
                    case 6:
                    gravarTrabajadoresMayores(todos);
                    break;    
                case 1: //Sortir
                    exit = true;
                    break;
    ...
    private static void carregarFitxer(Agenda todos) {
        ...
        try {
            todos.cargarTrabajadoresFichero("ficheros/trabajadoresMayores.dat");
...
//interaccio dao
    ...
    private static void gravarTrabajadoresMayores(Agenda todos) {
        int contador=0 ;
            try {
            contador = todos.salvarDatosFicheroMayores("ficheros/trabajadoresMayores.dat");
            
            System.out.println("Registros guardados de los mayores " + contador);
        } catch (IOException ex) {
            System.out.println(ex.getMessage());
            ex.printStackTrace();
        }
