...
public class PuntoMain {
    ...
    public static void main(String[] args) {
        ...
        //crida a funció static
        Punto nuevo = Punto.creaPuntoAleatorio();
         System.out.println("Coordenadas aleatorio:");
        nuevo.imprime();
        System.exit(0);
        ...
        System.out.println("Lllamo a setXY");
        ...
        punto2.imprime();
        punto3.imprime();
        System.out.println("Lllamo a desplaza");
